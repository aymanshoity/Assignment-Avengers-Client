...
const Assignment = ({ assignment, handleDelete, handleUpdate }) => {
    ...
    return (
        <div className="my-10 mx-8">
            <div className="card card-side lg:h-[200px] bg-gradient-to-r from-[#e879f9] to-[#fda4af] shadow-xl flex flex-col lg:flex-row ">
                <div>
                    <figure><img src={image} className="w-[200px] h-[200px] rounded-lg" alt="Movie" /></figure>
                </div>
